 ...
 * 폼 입력 CRUD 팝업창
 */
class TreeFormPopup extends Component
{
    use WithFileUploads;
    ...
    public function mount()
    {
        ...
        if(!$this->viewForm) {
            if(isset($this->actions['view']['form'])) {
                $this->viewForm = $this->actions['view']['form'];
            }
        }
...
BLADE;
        ...
        $this->viewFile = "jiny-table"."::tree.popup_forms";
